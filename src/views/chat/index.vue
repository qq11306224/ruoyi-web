...
<template>
  ...
  <div class="flex flex-col w-full h-full chat-content"
      ...
      <div id="scrollRef"
        ...
        <div id="image-wrapper"
          ...
          <template v-if="!dataSources.length">
            <div v-if="homeStore.myData.session.notify"
                ...
                <div class="help"
                  ...
                  <div  class="text"
                    ...
                    <div class="gpts-list">
                      ...
                      <div v-for="v in gptsFilterList"
                           :key="v.name"
                           class="gpts-item"
                           :style="{width: isMobile ? '100%' : 'calc(50% - 20px)', marginRight: '20px', padding: isMobile ? '5px 8px' : '14px 10px', 'margin-bottom': isMobile ? '8px' : '20px'}">
                        <NImage :src="v.logo"
                                ...
                                :style="{width: isMobile ? '23px' : '46px', height: isMobile ? '23px' : '46px'}">
                          <template #placeholder>
                            <div class="w-full h-full justify-center items-center flex">
                              <SvgIcon icon="line-md:downloading-loop"
                                       class="text-[60px] text-green-300"></SvgIcon>
                            </div>
                          </template>
                        </NImage>
                        <div :style="{width: `calc(100% - ${isMobile ? '43px' : '66px'})`, float: 'left', marginLeft: '10px'}">
                          <p class="info"
                             :title="v.info"> {{ v.info }}</p>
                          <p @click="goUseGpts(v)"
                             class="name"> {{ t('chat.used') }} {{ v.name }}</p>
                        </div>
                      </div>
                    </div>
          ...
          <template v-else>
            <div>
              <Message v-for="(item, index) of dataSources"
                       :key="index"
    ...
    <footer :class="footerClass"
      ...
      <div class="w-full max-w-[1100px] m-auto">
        <aiGptInput @handle-clear="handleClear"
                    @export="handleExport"
